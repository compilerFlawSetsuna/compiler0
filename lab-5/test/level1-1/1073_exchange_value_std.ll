...
define dso_local i32 @main() #0 {
  ...
  %11 = add nsw i32 %10, 1
  %12 = call i32 bitcast (i32 (...)* @putint to i32 (i32)*)(i32 noundef %11)
  store i32 10, i32* %4, align 4
  %13 = load i32, i32* %4, align 4
  %14 = call i32 bitcast (i32 (...)* @putch to i32 (i32)*)(i32 noundef %13)
  %15 = load i32, i32* %3, align 4
  %16 = call i32 bitcast (i32 (...)* @putint to i32 (i32)*)(i32 noundef %15)
  store i32 10, i32* %4, align 4
  %17 = load i32, i32* %4, align 4
  %18 = call i32 bitcast (i32 (...)* @putch to i32 (i32)*)(i32 noundef %17)
  ret i32 0
}
